...
const PATHS = {
  ADMIN: {
    ...
    PUBLIC: '/resources/suilven/silverstripe-email-template-generator/admin/client/dist/'
  },
  MODULE: {
    SRC: path.resolve(__dirname, 'client/src'),
    DIST: path.resolve(__dirname, 'client/dist'),
    BUNDLES: path.resolve(__dirname, 'client/src/bundles'),
    PUBLIC: '/resources/suilven/silverstripe-email-template-generator/client/dist/',
  },
